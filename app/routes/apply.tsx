...
const PET_TYPES = ["Dog", "Cat", "Bird", "Reptile", "Fish", "Small animal", "Other"];
    ...
    <div className="flex flex-col gap-2">
      {ROLES.map(({ role, label, desc }) => (
        ...
        >
          ...
          >
            {value === role && <div className="w-2 h-2 rounded-full bg-[#C4714A]" />}
          </div>
          <div>
            <p
...
export default function Apply() {
  ...
  function updateAdult(index: number, field: keyof AdditionalAdult, value: string | AdultRole) {
    setAdditionalAdults((prev) =>
  ...
  function handleChildrenChange(newCount: number) {
    ...
    if (newCount > current) {
      setChildList((prev) => [
        ...prev,
        ...Array.from({ length: newCount - current }, () => ({ name: "", dob: "" })),
      ]);
    } else {
    ...
    <div className="min-h-screen bg-[#F5F0E8]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="fixed top-0 left-0 right-0 z-30">
        <div className="h-[3px] bg-[#E8E1D9]">
          <div className="h-full bg-[#C4714A] transition-all duration-700" style={{ width: "14%" }} />
        </div>
        <div className="bg-[#F5F0E8]/90 backdrop-blur-sm">
          <div className="max-w-lg mx-auto px-5 py-3 flex items-center justify-between">
            ...
            <span className="text-xs text-[#7A7268] tracking-widest uppercase" style={{ fontFamily: "'DM Sans', sans-serif" }}>
              Step 1
            </span>
            <div className="w-12" />
          </div>
      ...
      <div className="max-w-lg mx-auto px-5 pt-[72px] pb-36">
        ...
        <div className="mt-8 mb-8">
          <p className="text-xs text-[#C4714A] tracking-widest uppercase font-medium mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Rental Application
          </p>
          <h1 className="text-[2.6rem] leading-[1.15] text-[#1C1A17] mb-3" style={{ fontFamily: "'Fraunces', serif", fontWeight: 300 }}>
            Let's start with
            <br />
            <em>the basics.</em>
          </h1>
          <p className="text-[#7A7268] text-sm leading-relaxed" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Tell us a little about yourself and who'll be moving in.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 mb-4 shadow-[0_1px_4px_rgba(28,26,23,0.07)]">
          ...
          <div className="flex items-center justify-between py-4 border-b border-[#F0EBE3]">
            ...
            <Stepper value={adults} onChange={handleAdultsChange} min={1} max={8} />
          </div>
          ...
          <div className="flex items-center justify-between py-4">
            ...
            <Stepper value={children} onChange={handleChildrenChange} min={0} max={8} />
          </div>
        ...
        {additionalAdults.length > 0 && (
          <div className="mb-4 space-y-3">
            {additionalAdults.map((adult, i) => (
              <div key={i} className="bg-white rounded-2xl p-5 shadow-[0_1px_4px_rgba(28,26,23,0.07)]">
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-9 h-9 rounded-full bg-[#F5E8DF] flex items-center justify-center flex-shrink-0">
                    <span className="text-sm text-[#C4714A]" style={{ fontFamily: "'Fraunces', serif", fontWeight: 400 }}>
                      {i + 2}
                    </span>
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    {adult.role && (
                      <p className="text-xs text-[#7A7268] mt-0.5 capitalize">{adult.role}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="mb-4">
                  <label className="block text-xs text-[#7A7268] mb-2" style={{ fontFamily: "'DM Sans', sans-serif" }}>
              ...
              <div key={i} className="bg-white rounded-2xl p-5 shadow-[0_1px_4px_rgba(28,26,23,0.07)]">
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-9 h-9 rounded-full bg-[#EEF2F8] flex items-center justify-center flex-shrink-0">
                    <span className="text-sm text-[#5B7BB5]" style={{ fontFamily: "'Fraunces', serif", fontWeight: 400 }}>
                      {i + 1}
                    </span>
                  </div>
                  <div>
        ...
        <div className="bg-white rounded-2xl p-5 mb-4 shadow-[0_1px_4px_rgba(28,26,23,0.07)]">
          ...
          <label className="block text-sm font-medium text-[#1C1A17] mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>
          ...
          <input
            ...
            style={{ fontFamily: "'DM Sans', sans-serif" }}
          />
          <p className="text-xs text-[#7A7268] mt-2" style={{ fontFamily: "'DM Sans', sans-serif" }}>
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <p className="text-xs text-[#7A7268] mt-0.5">Any furry, feathered, or scaly friends?</p>
              </div>
              <PawIcon />
            </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <p className="text-xs text-[#7A7268] mt-0.5">Will anyone smoke in or near the unit?</p>
              </div>
              <NoSmokingIcon />
            </div>
        ...
        {hasPets === true && (
          <div className="mt-4 space-y-3">
            {pets.map((pet, i) => (
              <div key={pet.id} className="bg-white rounded-2xl p-5 shadow-[0_1px_4px_rgba(28,26,23,0.07)]">
                {/* Card header */}
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-[#1C1A17] truncate">
                      {pet.name || (pet.type ? `${pet.type} ${i + 1}` : `Pet ${i + 1}`)}
                    </p>
                    {pet.breed && <p className="text-xs text-[#7A7268] mt-0.5 truncate">{pet.breed}</p>}
                  </div>
                ...
                {/* Notes */}
                <div>
                  <FieldLabel>Anything else the landlord should know?</FieldLabel>
                  <textarea
                    rows={3}
      ...
      <div className="fixed bottom-0 left-0 right-0 pointer-events-none z-20">
        <div className="bg-gradient-to-t from-[#F5F0E8] via-[#F5F0E8]/95 to-transparent pt-8 pb-10 px-5 pointer-events-auto">
          <div className="max-w-lg mx-auto">
            ...
            <p className="text-center text-xs text-[#7A7268] mt-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>
